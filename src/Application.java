...
public class Application {
	...
	public static void main(String[] args){
		...
		while(continuer){
			...
			System.out.println("Bienvenue sur l'application de la soci�t� Aurélio-Yoann-Arthur Inc.");
			System.out.println("Choisissez une action � effectuer");
			System.out.println("1-afficher la liste des articles");
			System.out.println("2-cr�er une commande");
			System.out.println("3-afficher les locations en cours");
			System.out.println("4-calcul des recettes sur une p�riode");
			...
			case 3:
				System.out.println("Veuillez s�lectionner un client parmi la liste : ");
				int index = 1;
				for(Client c : clients){
			...
			case 4:
				...
				do {
				System.out.println("Tapez la date de d�but de la p�riode au format jj/mm/aaaa");
				...
				do {
				System.out.println("Tapez la date de fin de la p�riode au format jj/mm/aaaa");
				...
				System.out.println("Le chiffre r�alis� sur la p�riode du " + dateDebutPeriode + " au " + 
								   dateFinPeriode + " est de " + benefice + "�");
				break;
				
			//5-restitution d'une location
			case 5:
				System.out.println("Veuillez s�lectionner une location parmi la liste : ");
				int index1 = 1;
